      ...
      <div className="container" style={{ paddingTop: "0" }}>
        ...
        <div className="main-grid">
          ...
          <div className="sidebar">
            {/* Slicers (Updated to use InfoTooltip) */}
            <div className="slicer-row">
              <div className="slicer-container">
                <div className="slicer-header">
                  <InfoTooltip text="Filter the simulation and KPIs by the selected Specialty." />
                  Specialty
                </div>
              ...
              <div className="slicer-container">
                <div className="slicer-header">
                  <InfoTooltip text="Filter the simulation and KPIs by the selected Surgeon(s)." />
                  Surgeon
                </div>
                <div className="slicer-items">
