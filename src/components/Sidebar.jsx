  ...
  return (
    <>
      ...
      <div className="sidebar-content">
        ...
        {activeSidebarTab === "demand" && (
          <DemandPanel
            assumptions={assumptions}
            onAssumptionChange={onAssumptionChange}
            isDemandProfileLoaded={demandPlanData.length > 0}
            TooltipComponent={InfoTooltip}
          />
        )}
        ...
        {activeSidebarTab === "data" && (
          <DataPanel
            ...
            TooltipComponent={InfoTooltip}
            onSetActiveTab={onSetActiveTab} // <-- PASSING IT DOWN TO DATAPANEL
          />
        )}
      </div>
    </>
